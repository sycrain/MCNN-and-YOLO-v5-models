...
if __name__ == '__main__':
    fileDir = r"D:\torchprojects\yolov5-master\VOCdevkit\VOC2007tang\JPEGImages" + "\\"  # 源图片文件夹路径
    tarDir = r'C:\Users\86159\Desktop\hat\JPEGImages_val'  # 图片移动到新的文件夹路径
    moveimg(fileDir, tarDir)
    file_list = os.listdir(tarDir)
    file_label_train = r"D:\torchprojects\yolov5-master\VOCdevkit\VOC2007tang"  # 源图片标签路径
