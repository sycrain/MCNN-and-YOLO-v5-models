...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='best.pt', help='initial weights path')#修改处

    parser.add_argument('--cfg', type=str, default='models/tang.yaml', help='model.yaml path')#修改处

    parser.add_argument('--data', type=str, default='data/tang.yaml', help='dataset.yaml path')#修改处
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.scratch.yaml', help='hyperparameters path')

    parser.add_argument('--epochs', type=int, default=1000)#修改处，显卡低的可以调到100，原来是300
